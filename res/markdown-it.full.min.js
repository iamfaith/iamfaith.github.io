...
!function(a){"object"==typeof exports&&"undefined"!=typeof module?module.exports=a():"function"==typeof define&&define.amd?define([],a):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).markdownitMath=a()}(function(){return(function(){function a(e,f,c){function d(b,k){if(!f[b]){if(!e[b]){var i="function"==typeof require&&require;if(!k&&i)return i(b,!0);if(g)return g(b,!0);var j=new Error("Cannot find module '"+b+"'");throw j.code="MODULE_NOT_FOUND",j}var h=f[b]={exports:{}};e[b][0].call(h.exports,function(a){return d(e[b][1][a]||a)},h,h.exports,a,e,f,c)}return f[b].exports}for(var g="function"==typeof require&&require,b=0;b<c.length;b++)d(c[b]);return d}return a})()({1:[function(b,a,c){"use strict";function d(c,b){let d,a,g=c.posMax,e=!0,f=!0;return d=b>0?c.src.charCodeAt(b-1):-1,a=b+1<=g?c.src.charCodeAt(b+1):-1,(32===d||9===d||a>=48&&a<=57)&&(f=!1),(32===a||9===a)&&(e=!1),{can_open:e,can_close:f}}function e(a,e){let c,b,g,f;if("$"!==a.src[a.pos])return!1;if(!d(a,a.pos).can_open)return e||(a.pending+="$"),a.pos+=1,!0;for(b=c=a.pos+1;-1!==(b=a.src.indexOf("$",b));){for(f=b-1;"\\"===a.src[f];)f-=1;if((b-f)%2==1)break;b+=1}return -1===b?(e||(a.pending+="$"),a.pos=c,!0):b-c==0?(e||(a.pending+="$$"),a.pos=c+1,!0):d(a,b).can_close?(e||((g=a.push("math_inline","math",0)).markup="$",g.content=a.src.slice(c,b)),a.pos=b+1,!0):(e||(a.pending+="$"),a.pos=c,!0)}function f(a,d,k,l){let e,g,c,j,i=!1,h,b=a.bMarks[d]+a.tShift[d],f=a.eMarks[d];if(b+2>f||"$$"!==a.src.slice(b,b+2))return!1;if(b+=2,e=a.src.slice(b,f),l)return!0;for("$$"===e.trim().slice(-2)&&(e=e.trim().slice(0,-2),i=!0),c=d;!i&&!(++c>=k)&&(b=a.bMarks[c]+a.tShift[c],f=a.eMarks[c],!(b<f)||!(a.tShift[c]<a.blkIndent));)"$$"===a.src.slice(b,f).trim().slice(-2)&&(j=a.src.slice(0,f).lastIndexOf("$$"),g=a.src.slice(b,j),i=!0);return a.line=c+1,(h=a.push("math_block","math",0)).block=!0,h.content=(e&&e.trim()?e+"\n":"")+a.getLines(d+1,c,a.tShift[d],!0)+(g&&g.trim()?g:""),h.map=[d,a.line],h.markup="$$",!0}a.exports=(b,a)=>{(a=a||{}).server=a.server||"https://math.now.sh",a.style=a.style||"";let c=a=>{try{return`\\( ${a} \\)`}catch(b){return console.error(b),a}},d=a=>{try{return`$$ ${a} $$`}catch(b){return console.error(b),a}};b.inline.ruler.after("escape","math_inline",e),b.block.ruler.after("blockquote","math_block",f,{alt:["paragraph","reference","blockquote","list"]}),b.renderer.rules.math_inline=(a,b)=>c(a[b].content),b.renderer.rules.math_block=(a,b)=>d(a[b].content)}},{}]},{},[1])(1)}),/*! markdown-it-latex2img 0.0.5 https://github.com/makergyt/markdown-it-latex2img @license MIT */ function(a){"object"==typeof exports&&"undefined"!=typeof module?module.exports=a():"function"==typeof define&&define.amd?define([],a):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).markdownitHeadingspan=a()}(function(){return(function(){function a(e,f,c){function d(b,k){if(!f[b]){if(!e[b]){var i="function"==typeof require&&require;if(!k&&i)return i(b,!0);if(g)return g(b,!0);var j=new Error("Cannot find module '"+b+"'");throw j.code="MODULE_NOT_FOUND",j}var h=f[b]={exports:{}};e[b][0].call(h.exports,function(a){return d(e[b][1][a]||a)},h,h.exports,a,e,f,c)}return f[b].exports}for(var g="function"==typeof require&&require,b=0;b<c.length;b++)d(c[b]);return d}return a})()({1:[function(b,a,c){"use strict";function d(a,b){var c=new RegExp(b.utils.lib.ucmicro.Z.source,"g");return encodeURIComponent(a.replace(c,""))}a.exports=(a,b)=>{var c,e=a.utils.assign({anchorClass:"markdown-it-headingspan",addHeadingSpan:!0,slugify:d},b);a.core.ruler.push("heading_span",(c=e,function(a){for(var b=0;b<a.tokens.length-1;b++)if("heading_open"===a.tokens[b].type&&"inline"===a.tokens[b+1].type){var d=a.tokens[b+1];if(d.content){if(c.addHeadingSpan){var e=new a.Token("html_inline","",0);e.content='<span class="prefix"></span><span class="content">',d.children.unshift(e);var f=new a.Token("html_inline","",0);f.content='</span><span class="suffix"></span>',d.children.push(f)}b+=2}}}))}},{}]},{},[1])(1)}),/*! markdown-it-latex2img 0.0.5 https://github.com/makergyt/markdown-it-latex2img @license MIT */ function(a){"object"==typeof exports&&"undefined"!=typeof module?module.exports=a():"function"==typeof define&&define.amd?define([],a):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).markdownitTable=a()}(function(){return(function(){function a(e,f,c){function d(b,k){if(!f[b]){if(!e[b]){var i="function"==typeof require&&require;if(!k&&i)return i(b,!0);if(g)return g(b,!0);var j=new Error("Cannot find module '"+b+"'");throw j.code="MODULE_NOT_FOUND",j}var h=f[b]={exports:{}};e[b][0].call(h.exports,function(a){return d(e[b][1][a]||a)},h,h.exports,a,e,f,c)}return f[b].exports}for(var g="function"==typeof require&&require,b=0;b<c.length;b++)d(c[b]);return d}return a})()({1:[function(b,a,c){"use strict";a.exports=a=>{a.core.ruler.push("table-container",function(b){for(var a=[],d=0;d<b.tokens.length;d++){var c=b.tokens[d];if("table_open"===c.type){var e=new b.Token("html_inline","",0);e.content='<section class="table-container">',a.push(e),a.push(c)}else if("table_close"===c.type){var f=new b.Token("html_inline","",0);f.content="</section>",a.push(c),a.push(f)}else a.push(c)}b.tokens=a})}},{}]},{},[1])(1)}),/*! markdown-it-latex2img 0.0.5 https://github.com/makergyt/markdown-it-latex2img @license MIT */ function(a){"object"==typeof exports&&"undefined"!=typeof module?module.exports=a():"function"==typeof define&&define.amd?define([],a):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).markdownitLi=a()}(function(){return(function(){function a(e,f,c){function d(b,k){if(!f[b]){if(!e[b]){var i="function"==typeof require&&require;if(!k&&i)return i(b,!0);if(g)return g(b,!0);var j=new Error("Cannot find module '"+b+"'");throw j.code="MODULE_NOT_FOUND",j}var h=f[b]={exports:{}};e[b][0].call(h.exports,function(a){return d(e[b][1][a]||a)},h,h.exports,a,e,f,c)}return f[b].exports}for(var g="function"==typeof require&&require,b=0;b<c.length;b++)d(c[b]);return d}return a})()({1:[function(b,a,c){"use strict";a.exports=a=>{var b;a.core.ruler.push("replace-li",(b=a,function(){b.renderer.rules.list_item_open=function(){return"<li><section>"},b.renderer.rules.list_item_close=function(){return"</section></li>"}}))}},{}]},{},[1])(1)}),/*! markdown-it-latex2img 0.0.5 https://github.com/makergyt/markdown-it-latex2img @license MIT */ function(a){"object"==typeof exports&&"undefined"!=typeof module?module.exports=a():"function"==typeof define&&define.amd?define([],a):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).markdownitTask=a()}(function(){return(function(){function a(e,f,c){function d(b,k){if(!f[b]){if(!e[b]){var i="function"==typeof require&&require;if(!k&&i)return i(b,!0);if(g)return g(b,!0);var j=new Error("Cannot find module '"+b+"'");throw j.code="MODULE_NOT_FOUND",j}var h=f[b]={exports:{}};e[b][0].call(h.exports,function(a){return d(e[b][1][a]||a)},h,h.exports,a,e,f,c)}return f[b].exports}for(var g="function"==typeof require&&require,b=0;b<c.length;b++)d(c[b]);return d}return a})()({1:[function(b,a,c){"use strict";function d(a,b,e){var c=a.attrIndex(b),d=[b,e];c<0?a.attrPush(d):a.attrs[c]=d}function e(b,c){for(var d=b[c].level-1,a=c-1;a>=0;a--)if(b[a].level===d)return a;return -1}function f(a,b){return m(a[b])&&n(a[b-1])&&o(a[b-2])&&p(a[b])}function g(a,e,c,b){var d;d=c.idPrefix+e,a.children[0].content=a.children[0].content.slice(3),a.children.unshift(i(d,b)),a.children.push(j(b)),a.children.unshift(h(a,d,c,b)),c.divWrap&&(a.children.unshift(k(c,b)),a.children.push(l(b)))}function h(b,c,d,e){var a=new e("checkbox_input","input",0);return a.attrs=[["type","checkbox"],["id",c]],!0===/^\[[xX]\][ \u00A0]/.test(b.content)&&a.attrs.push(["checked","true"]),!0===d.disabled&&a.attrs.push(["disabled","true"]),a}function i(b,c){var a=new c("label_open","label",1);return a.attrs=[["for",b]],a}function j(a){return new a("label_close","label",-1)}function k(b,c){var a=new c("checkbox_open","div",0);return a.attrs=[["class",b.divClass]],a}function l(a){return new a("checkbox_close","div",-1)}function m(a){return"inline"===a.type}function n(a){return"paragraph_open"===a.type}function o(a){return"list_item_open"===a.type}function p(a){return/^\[[xX \u00A0]\][ \u00A0]/.test(a.content)}a.exports=function(c,a){var b;b={disabled:!0,divWrap:!1,divClass:"checkbox",idPrefix:"cbx_",ulClass:"task-list",liClass:"task-list-item"},a=Object.assign({},b,a),c.core.ruler.after("inline","github-task-lists",function(h){for(var b=h.tokens,i=0,c=2;c<b.length;c++)f(b,c)&&(g(b[c],i,a,h.Token),i+=1,d(b[c-2],"class",a.liClass),d(b[e(b,c-2)],"class",a.ulClass))})}},{}]},{},[1])(1)}),/*! markdown-it-latex2img 0.0.5 https://github.com/makergyt/markdown-it-latex2img @license MIT */ function(a){"object"==typeof exports&&"undefined"!=typeof module?module.exports=a():"function"==typeof define&&define.amd?define([],a):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).markdownitMermaid=a()}(function(){return(function(){function a(e,f,c){function d(b,k){if(!f[b]){if(!e[b]){var i="function"==typeof require&&require;if(!k&&i)return i(b,!0);if(g)return g(b,!0);var j=new Error("Cannot find module '"+b+"'");throw j.code="MODULE_NOT_FOUND",j}var h=f[b]={exports:{}};e[b][0].call(h.exports,function(a){return d(e[b][1][a]||a)},h,h.exports,a,e,f,c)}return f[b].exports}for(var g="function"==typeof require&&require,b=0;b<c.length;b++)d(c[b]);return d}return a})()({1:[function(b,a,c){"use strict";a.exports=function(a){let b=a.renderer.rules.fence.bind(a.renderer.rules);a.renderer.rules.fence=(a,c,e,f,g)=>{let d=a[c];if("mermaid"===d.info){let h=d.content.trim();return`<div class="mermaid" style="text-align: center;">${h}</div>`}return b(a,c,e,f,g)}}},{}]},{},[1])(1)})