...
fontsize: 11pt
geometry: a4paper,left=2.2cm,right=2.2cm,top=1.3cm,bottom=1.7cm #margin=1in
...
Concordia University, Montreal, Quebec    \hfill      September 2019
...
*Development of Online preview Service WPS on Web (drive.wps.cn): converting Office documents to HTML, pdf, image, etc. *
  ...
  - Used Rapha??l  and canvas in HTML to plot the complex vector graphics in Office documents, compatible with IE8 and above
...
Software engineer          \hfill                     November 2014-August 2016
